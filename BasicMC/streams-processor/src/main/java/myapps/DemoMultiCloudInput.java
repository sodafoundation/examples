 ...
 */
public final class DemoMultiCloudInput {
            ...
            return new Processor<String, String>() {
                ...
                public void process(final String dummy, final String line) {
                    ...
                    for (final String word : words) {
                        ...
                        final Integer oldValue = this.kvStore.get(thing);

                        if (oldValue == null) {
                            this.kvStore.put(thing, 1);
                        } else {
                            this.kvStore.put(thing, oldValue + 1);
                        }
                    }
    ...
    public static void main(final String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "multicloud-input-demo");
        ...
        builder.addSource("Source", "multicloud-input");
        ...
        builder.addSink("Sink", "multicloud-output", "Process");

        final KafkaStreams streams = new KafkaStreams(builder, props);
        final CountDownLatch latch = new CountDownLatch(1);

        // attach shutdown handler to catch control-c
        Runtime.getRuntime().addShutdownHook(new Thread("multicloud-input-shutdown-hook") {
            @Override
            public void run() {
                streams.close();
                latch.countDown();
