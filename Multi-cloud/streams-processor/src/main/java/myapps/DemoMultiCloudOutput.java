 ...
 */
public final class DemoMultiCloudOutput {
    ...
    public static void main(final String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "multicloud-output-demo");
        ...
        builder.addSource("Source", "multicloud-input2");
        ...
        builder.addSink("Sink", "multicloud-output2", "Process");

        final KafkaStreams streams = new KafkaStreams(builder, props);
        final CountDownLatch latch = new CountDownLatch(1);

        // attach shutdown handler to catch control-c
        Runtime.getRuntime().addShutdownHook(new Thread("multicloud-output-demo-shutdown-hook") {
            @Override
            public void run() {
                streams.close();
                latch.countDown();
